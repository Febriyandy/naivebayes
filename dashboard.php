...
<body class="bg-gray-100">
    ...
    <img src="image/bg.jpeg" class="w-full h-1/2 relative object-cover mx-auto rounded-lg shadow-md opacity-60" alt="">
    <div class="absolute top-32 px-10 ">
    <h1 class="text-center font-bold text-3xl my-3 text-blue-900">Selamat Datang</h1>
    <h1 class="text-center  font-bold text-xl my-3 text-blue-900">Sistem Penentuan Kelayakan pada Program Indonesia Pintar (PIP) di SMA Muhammadiyah Tanjungpinang </h1>
    </div>
        ...
        <div class="flex justify-center gap-10 mt-5">
            ...
            <div class="w-60 h-40 bg-blue-900 rounded-lg shadow-md">
                ...
                <h1 class="font-bold text-center text-3xl text-white mt-2">23</h1>
            </div>
            </a>
